 ...
 *
 */
public abstract class SearchInputStream extends InputStream {
	 ...
	 * bytes. Smaller values take fewer bytes. Negative numbers will always use
	 * all 5 bytes and are therefore better serialized using {@link #readInt}
	 */
	...
	public String readString() throws IOException {
		...
		while (sb.length() < charCount) {
			...
			case 12:
			case 13:
				sb.append((char) ((c & 0x1F) << 6 | readByte() & 0x3F));
				break;
			case 14:
				sb.append((char) ((c & 0x0F) << 12 | (readByte() & 0x3F) << 6 | (readByte() & 0x3F)));
				break;
			}
		}
		return sb.toString();
