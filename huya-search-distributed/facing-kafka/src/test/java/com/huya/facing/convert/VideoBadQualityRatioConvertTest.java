...
/**
 * Created by zhangyiqun1@yy.com on 2018/3/13.
 */
public class VideoBadQualityRatioConvertTest {

    @Test
    public void runTest() throws IOException, IllegalAccessException, InstantiationException {
        ...
        Class groovyClass = GROOVY_CLASS_LOADER.parseClass(
                new GroovyCodeSource(Objects.requireNonNull(this.getClass().getClassLoader().getResource("convert/Video_bad_quality_ratioConvert.groovy")))
        );
        ...
        while (true) {
            ...
            if (key == null) break;
            try {
                SearchDataRow searchDataRow = convert.convert(0, 0, value.getBytes(), key.getBytes());
