...
MAIN_CLASS=com.huya.search.HuyaSearch
APP_NAME=distributed-huya-search
JAVA_OPTS="-Xms16384m -Xmx16384m -Dfile.encoding=UTF8 -Djava.security.auth.login.config=/home/huya-search/workspace/conf/kafka_client_jaas.conf"
