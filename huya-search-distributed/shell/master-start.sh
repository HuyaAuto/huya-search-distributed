...
MAIN_CLASS=com.huya.search.HuyaSearchMaster
APP_NAME=distributed-huya-search-master
JAVA_OPTS="-Xms300m -Xmx300m -Dfile.encoding=UTF8 -Djava.security.auth.login.config=/home/huya-search/workspace/conf/kafka_client_jaas.conf"
