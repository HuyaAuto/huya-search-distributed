...
MAIN_CLASS=com.huya.search.facing.subscriber.TakeScoopSubscriber
APP_NAME=distributed-huya-search
JAVA_OPTS="-Xms2048m -Xmx4096m -Dfile.encoding=UTF8  -Djava.security.auth.login.config=/home/huya-search/workspace/conf/kafka_client_jaas.conf"
