...
public class DistributedPartitionsFactory implements PartitionsFactory {
    ...
    @Override
    public Partitions createTimelinePartitions(Settings settings, TimelineMetaDefine timelineMetaDefine,
                                               ShardInfosService shardInfosService, ShardsFactory shardsFactory) {
        return new DistributedIndexPartitions(settings, timelineMetaDefine, shardInfosService, shardsFactory);
    }
}
